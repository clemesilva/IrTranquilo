  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignUp) {
        ...
        toast.success('Cuenta creada. Te va a llegar un mail de confirmación para activar tu cuenta.');
        setIsSignUp(false);
        setPassword('');
    ...
    >
      ...
      >
        ...
        <div className='flex flex-col items-center gap-5 text-center'>
          ...
          <div>
            ...
            <p className='mt-2 text-lg text-white/70'>Anda tranquilo, nosotros ya fuimos.</p>
          </div>
        </div>
        ...
        <div className='flex flex-col gap-4 w-full max-w-sm'>
          {[
            { icon: AppIcons.Search, text: 'Encuentra lugares con información de accesibilidad verificada' },
            { icon: AppIcons.ClipboardList, text: 'Evalúa rampas, ascensores y entradas adaptadas' },
            { icon: AppIcons.Share2, text: 'Contribuye y ayuda a otros a moverse con libertad' },
          ].map((item) => (
      ...
      <div className='flex flex-1 flex-col items-center justify-center px-6 py-12'>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className='space-y-4'>
            {isSignUp && (
              <div className='space-y-1.5'>
                <Label htmlFor='display-name' className='text-sm font-semibold' style={{ color: COLORS.text }}>
                  Nombre
                </Label>
                <Input
                  id='display-name'
            ...
            <div className='space-y-1.5'>
              <Label htmlFor='email' className='text-sm font-semibold' style={{ color: COLORS.text }}>
                Email
              </Label>
              <Input
                id='email'
            ...
            <div className='space-y-1.5'>
              <Label htmlFor='password' className='text-sm font-semibold' style={{ color: COLORS.text }}>
                Contraseña
              </Label>
              <Input
                id='password'
          ...
          {/* Toggle login/signup */}
          <p className='mt-5 text-center text-sm' style={{ color: COLORS.textMuted }}>
