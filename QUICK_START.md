...
1. Creo `src/services/supabase.ts`
2. Creo `src/context/AuthProvider.tsx` + `src/context/useAuth.ts`
3. Actualizo `src/context/PlacesProvider.tsx` para conectarse a BD real
4. Creo `src/pages/LoginPage.tsx` y `src/pages/SignupPage.tsx`
5. Conectamos todo y probamos
...
```
Email: demo@irtranquilo.com
Contraseña: (la que pusiste al crear proyecto, o crea uno nuevo)
```

Ya vienen 5 lugares + reseñas insertados automáticamente.
